...
%   增量同时受 chromaProtectionMask、structureProtectionMask、硬保护和
...
[chromaProtection, hasChromaProtection] = resolveChromaProtectionMask( ...
    beautyMasks, imageSize, 'beauty:InvalidWhiteningInput', ...
...
chromaGate = 1 - .86 * chromaProtection;
...
whiteningSupport = whiteningCurve .* allowed .* highlightProtection .* ...
    structureGate .* chromaGate .* featureSetback;
...
[~, ~] = resolveChromaProtectionMask(beautyMasks, imageSize, ...
    'beauty:InvalidWhiteningInput', 'beauty:ChromaProtectionConflict');
end
