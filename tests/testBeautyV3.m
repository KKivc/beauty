...
%   makeBaseLuminanceStageContract（T16/T30）的未折叠字段公式，供消费侧
%   等价断言与扰动负向证明使用。T30 起 featureGate 保持"未带"语义，
%   分级保护经 regionBandGate（1 - protection.regionBandBase）单独发布，
%   只作用于逐像素 supportMap。
contract = struct( ...
    ...
    'regionBandGate', 1 - protection.regionBandBase);
end
