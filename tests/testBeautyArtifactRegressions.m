...
[protection, hard] = buildFeatureProtectionMasks( ...
...
faceBox = [1, 1, imageSize(2), imageSize(1)];
context = plainSkinContext(imageSize, faceBox);
context.hardProtectionMask = double(hardMask);
context.featureProtectionMask = double(hardMask);
...
function context = plainSkinContext(imageSize, faceBox)
